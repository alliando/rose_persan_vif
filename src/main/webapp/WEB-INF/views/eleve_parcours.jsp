...
<div class="container">
    <div class="element btn-group btn-group-lg">
        ...
        <button class="btn btn-success href_button" onclick="self.location.href='eleve_profilRespo'" ><h2>Responsable de parcours</h2><h5>nom, contact</h5></button>
        <button class="btn btn-success href_button" onclick="self.location.href='eleve_temoignage'"><h1>Témoignages</h1><h5>d'anciens élèves</h5></button>
    </div>
    <hr>
    <!-- Footer -->
    <footer>
