...
<div class="container">
    <div class="element btn-group btn-group-lg">
        <button class="btn btn-success href_button" onclick="self.location.href='http://www.isep.fr/parcours/index.html'"><h1>Liste des parcours</h1><h5>tableau comparatif</h5></button>
