    ...
    <div class="row">
        <div class="col-sm-4 col-md-2 col-sm-push-8 col-md-push-10">
            ...
            <c:if test="${(eleve.type).equals('eleve')}">
                ...
                <div class="glyphicon glyphicon-envelope"> Contacter tous les élèves de mon parcours</div></a>
        </div>
        <div class="col-sm-8 col-sm-pull-4 col-md-pull-0 ">
            <table class="table table-condensed table-hover table-bordered" >
                ...
                <c:if test="${(eleve.type).equals('eleve')}">
                <tr  onclick="self.location.href='respo_eleve_profil?id=${eleve.getId()}'">
                    <td>${eleve.getNomFamille()}       <td>${eleve.getPrenom()}    <td><a href="mailto:${eleve.getMail()}">${eleve.getMail()}</a> <td class="hide">${eleve.getIdParcours()}</td>
                    </c:if>
                    </c:forEach>
            </table>
        </div>
