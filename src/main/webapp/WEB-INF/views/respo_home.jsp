...
<title>Responsable - Accueil </title>
    ...
    <div class="element btn-group btn-group-lg">
        ...
        <button class="btn btn-success href_button" onclick="self.location.href='respo_international'"><h1>International</h1><h5>Université, cours</h5></button>
        <button class="btn btn-success href_button" onclick="self.location.href='admin_temoignage'"><h1>Témoignages</h1></button>
    </div>
</div>
