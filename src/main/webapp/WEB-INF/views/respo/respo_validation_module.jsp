...
<div class="container">
	...
	<form name="form1" method="POST" action="">
		<div class="row">
			<p id="infotem">
				<b>Nom de l'étudiant :</b> ${eleve.getNom()} <br></br>
				<b>Cours choisis :</b> ${module.getDescription()} <br></br>
				<b>Nom de l'université :</b> ${module.getNomuniv()}<br></br>
				<b>Lien vers le catalogue de cours :</b> <a
					href="${module.getLien()}">${module.getLien()}</a>
			</p>
			<br> <label for="Commentaire">Commentaire:</label>
			<textarea style="height: 120px" class="form-control" id="Commentaire"
				name="Commentaire" placeholder="Indiquer ici vos commentaires"
				cols="" rows=""></textarea>
			...
			<button type="submit" value="bouton2" name="bouton2"
				class="btn btn-default btn-lg btn-block active"
				onclick="validerBouton2()">Les modules ne correspondent pas
				aux critères</button>
		</div>
	</form>
