...
<div class="container">
	...
	<div class="row">
		<p id="infotem">Lorem ipsum dolor sit amet, consectetur adipiscing
		...
		<br>
		<button type="submit" class="btn btn-default btn-lg btn-block active">Valider
			les modules</button>
		<button type="submit" class="btn btn-default btn-lg btn-block active">Les
			modules ne correspondent pas aux critères</button>
