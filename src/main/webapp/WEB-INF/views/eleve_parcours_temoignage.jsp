...
<body>
<!-- deco -->
<a class="span6 pull-right" id="deco" href="deconnexion.php"><input type="button" value="D�connexion"></a>
 <!-- Navigation -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">T�moignages
                    <small></small>
                </h1>
            </div>
        </div>
...
<div class="row">
		...
		<span class="form-group col-sm-12 col-md-12">
			<select class="col-sm-4 col-md-4" name="tsearch">
			    ...
			    <option value="Numerique et Sant�">Numerique et Sant�</option>
			</select>
			<a href="#" id="DepotTemoignage" class="pull-right btn btn-primary btn-lg active" role="button" href="DepotTemoignage.jsp">D�poser un T�moignage</a>	
		</span>
		</div>
		<div id="allBlock"  class="temoignage col-sm-12 col-md-12">
		<div id="Block"  class="temoignage col-sm-12 col-md-12" style="display:none">
		<div id="bigblock"><h3 id="parcours">G�nie Logiciel</h3> <h3 id="etpromo">Tintin Haddock, promo 2017</h3>
		</div>
		...
		<div id="Block"  class="temoignage col-sm-12 col-md-12" style="display:none">
		<div id="bigblock"><h3 id="parcours">Syst�mes Embarqu�s</h3> <h3 id="etpromo">Johny John, promo 2015</h3>
		</div>
		...
		<div id="Block" class="temoignage col-sm-12 col-md-12" style="display:none">
		<div id="bigblock"><h3 id="parcours">G�nie Logiciel</h3> <h3 id="etpromo">Franky Vincent, promo 2017</h3>
		</div>
