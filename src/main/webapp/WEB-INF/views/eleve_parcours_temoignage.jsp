...
<div class="row">
		...
		<div class="bigblock"><h3 class="parcours">G�nie Logiciel</h3> <h3 class="etpromo">Tintin Haddock, promo 2017</h3>
		</div>
		<p class="info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi. Proin porttitor, orci nec nonummy molestie, enim est eleifend mi, non fermentum diam nisl sit amet erat. Duis semper.</p>
		</div>
		
		<div   class="Block col-sm-12 col-md-12" style="display:none">
		<div class="bigblock"><h3 class="parcours">Syst�mes Embarqu�s</h3> <h3 class="etpromo">Johny John, promo 2015</h3>
		</div>
		...
		<div  class="Block col-sm-12 col-md-12" style="display:none">
		<div class="bigblock"><h3 class="parcours">G�nie Logiciel</h3> <h3 class="etpromo">Franky Vincent, promo 2017</h3>
		</div>
