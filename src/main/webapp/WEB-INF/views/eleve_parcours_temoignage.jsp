...
<body>
<!-- deco -->
<a class="span6 pull-right" id="deco" href="deconnexion.php"><input type="button" value="Déconnexion"></a>
 <!-- Navigation -->
...
<div class="row">
		...
		<div class="bigblock"><h3 class="parcours">Génie Logiciel</h3> <h3 class="etpromo">Tintin Haddock, promo 2017</h3>
		</div>
		<p class="info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi. Proin porttitor, orci nec nonummy molestie, enim est eleifend mi, non fermentum diam nisl sit amet erat. Duis semper.</p>
		</div>
		
		<div   class="Block col-sm-12 col-md-12" style="display:none">
		<div class="bigblock"><h3 class="parcours">Systèmes Embarqués</h3> <h3 class="etpromo">Johny John, promo 2015</h3>
		</div>
		<p class="info">Nihil est enim virtute amabilius, nihil quod magis adliciat ad diligendum, quippe cum propter virtutem et probitatem etiam eos, quos numquam vidimus, quodam modo diligamus. Quis est qui C. Fabrici, M'. Curi non cum caritate aliqua benevola memoriam usurpet, quos numquam viderit? quis autem est, qui Tarquinium Superbum, qui Sp. Cassium, Sp. Maelium non oderit? Cum duobus ducibus de imperio in Italia est decertatum, Pyrrho et Hannibale; ab altero propter probitatem eius non nimis alienos animos habemus, alterum propter crudelitatem semper haec civitas oderit.</p>
		</div>
		
		<div  class="Block col-sm-12 col-md-12" style="display:none">
		<div class="bigblock"><h3 class="parcours">Génie Logiciel</h3> <h3 class="etpromo">Franky Vincent, promo 2017</h3>
		</div>
		<p class="info">Iamque lituis cladium concrepantibus internarum non celate ut antea turbidum saeviebat ingenium a veri consideratione detortum et nullo inpositorum vel conpositorum fidem sollemniter inquirente nec discernente a societate noxiorum insontes velut exturbatum e iudiciis fas omne discessit, et causarum legitima silente defensione carnifex rapinarum sequester et obductio capitum et bonorum ubique multatio versabatur per orientales provincias, quas recensere puto nunc oportunum absque Mesopotamia digesta, cum bella Parthica dicerentur, et Aegypto, quam necessario aliud reieci ad tempus.</p>
		</div>
		</div>
